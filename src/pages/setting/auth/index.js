...
class Pagination extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tabs: [{
        title: '账号管理',
        key: `/${window.storeId}/setting/store/authority/staff`,
        // disabled: true
      }, {
        title: '角色管理',
        key: `/${window.storeId}/setting/store/authority/roles`
      }],
      type: this.props.location.pathname === `/${window.storeId}/setting/store/authority/staff` ? TAB_TYPE.USERS : TAB_TYPE.ROLE,
    };
  }
  componentWillMount() {
    ...
    return (
      <Fragment>
        ...
        <Card>
          {/* <Develop/> */}
          {
            this.state.type == TAB_TYPE.USERS ? (
              <USERS />
            ) : (
                <ROLE />
              )
